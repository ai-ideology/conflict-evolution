...
一个以**鹰鸽博弈**（Hawk–Dove Game）为背景的渐进式互动网页游戏。
...
- [x] 阶段一：脚手架 + 设计系统 + Slide 引擎 + 单次对决
- [x] 阶段二：群体演化模拟、纯鹰/纯鸽世界的入侵
- [x] 阶段三：冲突代价、资源稀缺、个体学习、组织秩序
- [x] 阶段四：群体实验室基础版 + 五幕互动总结初版
- [ ] 阶段五：实验对照、完整响应式视觉验收、音效与细节打磨

继续开发前请先阅读 HANDOFF.md 和 STORYBOARD.md。
